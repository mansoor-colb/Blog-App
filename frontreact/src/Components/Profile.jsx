...
if(input!=undefined && passwordd!="" && phonee!=""){
    var options = {
        method: 'PUT',
        url: 'http://127.0.0.1:8000/vlogapi/updateuser/',
        data: {uid: uid, username:input,password:passwordd,phone:phonee }
        };
                      ...
                      <div id="formAccountSettings">
                        <div class="row">
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" id="firstName" placeholder={prof.username} name="firstName" value={input} 
           onChange={(e) => setInput(e.target.value)}/>
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="lastName" class="form-label">Password</label>
                            <input class="form-control" type="text" name="lastName" id="lastName" value={passwordd} onChange={(e) => setPass(e.target.value)} placeholder={prof.password}/>
                          </div>
                          <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" id="organization" name="organization" value={email} disabled onChange={(e) => setmail(e.target.value)} placeholder={prof.email}/>
                          </div>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" id="phoneNumber" placeholder={prof.phone} name="phoneNumber" value={phonee} onChange={(e) => setphone(e.target.value)} class="form-control"/>
                            </div>
                          </div>
