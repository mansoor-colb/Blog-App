...
const Header = (prop) => {
  return (
    <>
    <aside id="layout-menu" class={"layout-menu menu-vertical menu bg-menu-theme "+prop.stat}>
        
        <div class="app-brand demo" id="appb">
          <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">bLOG</span>
          </a>

          <a  class="layout-menu-toggle menu-link text-large ms-auto d-block d-xl-none">
            <i class="bx bx-chevron-left bx-sm align-middle">889</i>
          </a>
        </div>
